       ...
       <div class="span12">
        ...
        ================================================== -->
         ...
         <?php
          ...
          $s_event_query = $conn->query("select * from sub_event where txtpollview='activated'") or die(mysql_error());
                ...
                ?>
                 ...
                 <tr>
                   ...
                   <td>
                     ...
                     <h3 id="progress-animated"><?php echo $showContTProw['rand_code']; ?></h3>
