           ...
           <div class="input-group">
             ...
             <div class="alert alert-info">
               ...
               <form method="POST">
                 ...
                 <br />
                 <input id="myInputOP" style="font-size: large; height: 45px !important;" class="form-control btn-block" name="user_password" type="password" autocomplete="on" placeholder="Enter Organizer's Password" />
           ...
           <?php
            ...
            if ($ame_query->rowCount() <= 0) { ?>
             ...
             <div class="alert alert-warning">
               <h3><strong>NO ACTIVE EVENT</strong></h3>
             </div>
             <?php } else {
              ...
              if ($ase_query->rowCount() <= 0) { ?>
               ...
               <div class="alert alert-warning">
                 <h3><strong>NO ACTIVE SUB-EVENT</strong></h3>
               </div>
             <?php } else {
