            ...
            while ($sy_row = $sy_query->fetch()) {
              ...
              <tr>
                ...
                <td>
                  ...
                  <a data-toggle="collapse" href="#MainEvents<?php echo $sy; ?>" style="text-align: left !important; text-indent: 7px !important" class="btn btn-warning btn-block"><i class="icon icon-folder-close"></i><?php echo $sy; ?> <span class="badge badge-info pull-right" style="margin-right: 7px !important;"><strong><?php if ($MECtr > 0 and $MECtr < 2) {
                                                                                                                                                                                                                                                                                                                                        echo $MECtr . " Event";
                                                                                                                                                                                                                                                                                                                                      } elseif ($MECtr > 1) {
                                                                                                                                                                                                                                                                                                                                        echo $MECtr . " Events";
                                                                                                                                                                                                                                                                                                                                      } else {
