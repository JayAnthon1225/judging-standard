 ...
 <body data-spy="scroll" data-target=".bs-docs-sidebar">
   ...
   <div class="navbar navbar-inverse navbar-fixed-top">
     <div class="navbar-inner">
       <div class="container">
         ...
         <!--   <a class="brand" href="#"><img src="uploads/<?php echo $company_logo; ?>" width="23" height="23" />&nbsp; <font size="3">Automatic Tabulation System</font></a> -->
   ...
   <header class="jumbotron subhead" id="overview">
     <div class="container">
       ...
       <p class="lead">Automatic Tabulation System</p>
     </div>
   </header>
     ...
     <div class="span12">
       ...
       <form method="POST">
         ...
         <div id="myGroup">
           ...
           <a class="btn btn-info" style="margin-bottom: 4px !important;" data-toggle="collapse" data-target="#textpoll" data-parent="#myGroup"><i class="icon-chevron-right"></i> <strong>TEXT POLL</strong></a>
                        ...
                        ?>
                         ...
                         <tr>
                           ...
                           <td width="115">
                             ...
                             <input name="selector[]" type="checkbox" value="<?php echo $cont_id; ?>" title="Check to select <?php echo $cont_row['fullname']; ?>" />
                           </td>
               ...
               <tr>
                 <td colspan="5">
                   <form method="POST">
                     ...
                     &nbsp;<a class="btn btn-primary" href="updateTxtview.php?sid=<?php echo $sub_event_id; ?>" target="_blank" title="Click to view textpoll votes">Text Poll Live View</a>
                     &nbsp;<a class="btn btn-primary" href="updateBlankTxtview.php?sid=<?php echo $sub_event_id; ?>" target="_blank" title="Click to view textpoll votes">Blank Text Poll Live View</a>
                     &nbsp;<a class="btn btn-primary" href="txt_pollData.php?sid=<?php echo $sub_event_id; ?>" target="_blank" title="Click to view textpoll votes">View Text Poll Data</a>
                   </form>
