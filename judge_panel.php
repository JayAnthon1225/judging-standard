                 ...
                 <table style="background-color: #44BA2B; width: 100% !important; height: 150px; text-indent: 25px;" align="center" border="0">
                     <tr>
                         <td>
                             ...
                             <h4 style="color: whitesmoke !important;">Automatic Tabulation System</h4>
                         </td>
                     </tr>
                 </table>
                         ...
                         <?php
                            ...
                            ?>
                             ...
                             <?php if ($getContestant_id == "allTally") { ?>
                                 ...
                                 <li><a href="selection.php"><strong>
                         ...
                         <footer class="footer">
                             ...
                             <?php
                                ...
                                ?>
                                 ...
                                 <?php if ($getContestant_id == "allTally") { ?>
                                     ...
                                     <a> &middot; </a><a href="selection.php"><strong>
                                             <font color="red">Exit</font>
                                         </strong></a>
                                 <?php } else { ?>
                             ...
                             <!--   <div class="container">
                                 <center>
                                     ...
                                     <font size="4">Electronic Judging System &middot; 2016 &COPY;</font>
                                     <hr />
