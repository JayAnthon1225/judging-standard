            ...
            <script type="text/javascript">
              jQuery(document).ready(function($) {
                $('.my-formxj .add-boxxj').click(function() {
                  ...
                  var boxxj_html = $('<p class="text-boxxj"><label for="boxxj' + j + '">Criteria No. <span class="boxxj-number">' + j + '</span></label> <input type="text" placeholder="Description" name="crit' + j + '" value="" id="boxxj' + j + '" required="true" /> &nbsp;&nbsp;&nbsp;Criteria Points: <select style="margin-top: 5px !important;" name="cp' + j + '"> <?php $n1 = -1;
                                                                                                                                                                                                                                                                                                                                                                              while ($n1 < 100) {
                                                                                                                                                                                                                                                                                                                                                                                $n1 = $n1 + 1;
                                                                                                                                                                                                                                                                                                                                                                                echo "<option>" . $n1 . "</option>";
                                                                                                                                                                                                                                                                                                                                                                              } ?> </select>% <a href="#" class="remove-boxxj">Remove</a></p>');
                  boxxj_html.hide();
